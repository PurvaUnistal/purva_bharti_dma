...
// static String BaseUrl = "https://citygas.hpcl.co.in/";
  ...
  static String saveDmaRegistrationDocsStep2 =BaseUrl+ "api/saveDmaRegistrationDocsStep2";
  static String saveDmaRegistrationDocs = BaseUrl+"api/saveDmaRegistrationDocs";
  static String saveDmaRegistrationDocsOffline = BaseUrl+"api/saveDmaRegistrationDocsOffline";
  static String saveDmaRegistrationDocsStep2Offline =BaseUrl+ "api/saveDmaRegistrationDocsStep2Offline";
  static String saveCustomerConsentOffline = BaseUrl+"api/storeConsentOffline";
  static String saveSecurityDepositOffline = BaseUrl+"api/saveSecurityDepositOffline";
  ...
  static String btnSubmit = "BtnSubmit";


  static var headerData = {HttpHeaders.authorizationHeader: "Basic YmFzaWNBdXRoOlVuaXN0YWxAMTk5NA=="};
  ...
  static String getSocietyAllow = '$BaseUrl' + "api/getConstant?key=societyAllow";
  static String getResidentStatus = '$BaseUrl' + "api/getConstant?key=residentStatus";
  static String getExistingCookingFuel = '$BaseUrl' + "api/getConstant?key=existingCookingFuel";
  static String getGuardianType = '$BaseUrl' + "api/getConstant?key=guardian_type";
  static String getIdentityProof = '$BaseUrl' + "api/getConstant?key=identityProof";
  static String getOwnershipProof = '$BaseUrl' + "api/getConstant?key=ownershipProof";
  static String getKycDoc = '$BaseUrl' + "api/getConstant?key=kycDoc";

  static String getEbilling = '$BaseUrl' + "api/getConstant?key=ebilling";
  static String getAcceptConversionPolicy = '$BaseUrl' + "api/getConstant?key=acceptConversionPolicy";
  static String getAcceptExtraFittingCost = '$BaseUrl' + "api/getConstant?key=acceptExtraFittingCost";
  ...
  static String getInitialDepositeStatus = '$BaseUrl' + "api/getConstant?key=initialDepositeStatus";
  static String getMdeOfDeposite = '$BaseUrl' + "api/getConstant?key=modeOfDeposite";
  static String getNoInterested = '$BaseUrl' + "api/getConstant?key=notIntrested";
