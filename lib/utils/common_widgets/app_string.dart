...
class AppStrings{
  ...
  static  String    electricBillFrontImgPath = '';
  static  String    electricBillBackImgPath = '';
  static  String   nocFrontImgPath = '';
  static  String  nocBackImgPath = '';
  static  String consentPhotoPath = '';
  static  String  chqCancelledPhotoPath = '';
  static  String chqPhotoPath = '';
  static  String    kycImagePath = '';
  static   File frontImage;
  static   File  backImage;
  static   File    electricBillFrontImg;
  static   File    electricBillBackImg;
  static   File   nocFrontImg;
  static   File    nocBackImg;
  static   File  consentPhoto;
  static   File   chqCancelledPhoto;
  static   File  chqPhoto;
