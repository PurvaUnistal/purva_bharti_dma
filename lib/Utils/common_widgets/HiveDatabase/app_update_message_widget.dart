...
class AppUpdateMessage {
  static showAlertDialog(
    ...
    Widget continueButton = TextButton(
      child: Text(
        "Update Now",style: TextStyle(fontSize: 14,color: AppColor.prime, fontWeight: FontWeight.w700),
      ),
      onPressed:onPressed
    );
    CupertinoAlertDialog alert = CupertinoAlertDialog(
      title: Builder(builder: (context) {
        return Text(
          "Update Available",style: TextStyle(fontSize: 16,color: AppColor.prime, fontWeight: FontWeight.w700),
        );
      }),
      content: Text(
