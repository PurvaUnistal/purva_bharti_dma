...
import 'package:pbg_app/Utils/common_widgets/SharedPerfs/prefs_value.dart';
...
import 'package:pbg_app/Utils/common_widgets/res/app_navigator.dart';
...
class ApiHelperDio {
  ...
  static Future<dynamic> backgroundServicePost({
    ...
    try {
      ...
      final baseUrl = await SharedPref.getString(
        key: PrefsValue.baseUrl,
      );
