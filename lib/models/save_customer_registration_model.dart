...
class SaveCustomerRegistrationModel {
  ...
  factory SaveCustomerRegistrationModel.fromRawJson(String str) =>
      SaveCustomerRegistrationModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory SaveCustomerRegistrationModel.fromJson(Map<String, dynamic> json) =>
      SaveCustomerRegistrationModel(
...
class SaveCusRegData {
  ...
  factory SaveCusRegData.fromJson(Map<String, dynamic> json) => SaveCusRegData(
        ...
        initialDepositeDate: json["initial_deposite_date"] == null
            ? DateTime.parse('0000-00-00')
            : DateTime.parse(json["initial_deposite_date"]),
...
class SaveCustRegReqModel {
  ...
  SaveCustRegReqModel(
      ...
      required this.canceledCheque,
      required this.chequeBankAccount,
      required this.chequeNumber,
      required this.customerConsent,
      required this.depositeType,
      required this.districtId,
      required this.dmaUserId,
      required this.dmaUserName,
      required this.backSideImg1,
      required this.backSideImg2,
      required this.backSideImg3,
      required this.docUploadsImg1,
      required this.docUploadsImg2,
      required this.docUploadsImg3,
