...
List<ChargeAreaModel> chargeAreaModelFromJson(String str) => List<ChargeAreaModel>.from(json.decode(str).map((x) => ChargeAreaModel.fromJson(x)));

String chargeAreaModelToJson(List<ChargeAreaModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
