...
//   List<Data> data;
//
//   castbyphone1({this.status, this.data});
//
//   castbyphone1.fromJson(Map<String, dynamic> json) {
//     status = json['status'];
//     if (json['data'] != null) {
//       data = new List<Data>();
//       json['data'].forEach((v) {
...
//   Null markStatusTime;
//   Null marketingRejectReason;
//   String accountingApproval;
//   Null accountingTime;
//   Null accontingRejectReason;
//
//   Approval(
