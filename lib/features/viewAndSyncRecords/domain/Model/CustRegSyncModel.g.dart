...
class CustRegSyncAdapter extends TypeAdapter<CustRegSync> {
  ...
  CustRegSync read(BinaryReader reader) {
    ...
    return CustRegSync(
      ...
      customerPhoto: fields[73] as File?,
      housePhoto: fields[74] as File?,
      ownerConsent: fields[75] as File?,
      customerConsent: fields[76] as File?,
      backside1: fields[60] as File?,
      backside2: fields[61] as File?,
      canceledCheque: fields[69] as File?,
      backside3: fields[62] as File?,
      acceptConversionPolicy: fields[22] as String?,
      acceptExtraFittingCost: fields[23] as String?,
      kycDocument1Image: fields[66] as File?,
      kycDocument2Image: fields[67] as File?,
      kycDocument3Image: fields[68] as File?,
      ...
      documentUploads1: fields[63] as File?,
      documentUploads2: fields[64] as File?,
      documentUploads3: fields[65] as File?,
      uploadCustomerPhoto: fields[70] as File?,
      uploadHousePhoto: fields[71] as File?,
      id: fields[0] as int?,
