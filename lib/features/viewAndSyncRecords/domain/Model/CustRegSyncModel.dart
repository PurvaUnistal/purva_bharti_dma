...
class CustRegSync {
  ...
  factory CustRegSync.fromJson(Map<String, dynamic> json) => CustRegSync(
    ...
    modeOfDeposit: json["mode_of_deposite"] == null ? "" :json["mode_of_deposite"],
    dmaDirPath: json["dma_dir_path"] == null ? "" :json["dma_dir_path"],
    ...
    nameOfBank: json["name_of_bank"] == null ? "" :json["name_of_bank"],
    ...
    initialDepositStatus: json["initial_deposite_status"] == null ? "" :json["initial_deposite_status"],
    nearestLandmark: json["reason_for_hold"] == null ? "" :json["reason_for_hold"],
    depositType: json["deposite_type"] == null ? "" :json["deposite_type"],
  initialAmount: json["initial_amount"] == null ? "" :json["initial_amount"],
    chequeNumber: json["cheque_number"] == null ? "" :json["cheque_number"],
    paymentBankName: json["payement_bank_name"] == null ? "" :json["payement_bank_name"],
    micr: json["micr"] == null ? "" : json["micr"],
